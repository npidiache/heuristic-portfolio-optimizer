...
- **Selection statistics and calibration framework** (commits `d87db66`, `bdbef99`): Holm–Bonferroni, probabilistic/deflated Sharpe ratios, and the `hive_abc.calibration` walk-forward runner — §4 applies the statistics to this grid.
...
| universe   | period         | model                            |   p_value | significant   | winner                    | holm_significant   |
|:-----------|:---------------|:---------------------------------|----------:|:--------------|:--------------------------|:-------------------|
| fixed      | covid_2020     | ABC-FAEM active mt=9             |    0.0192 | True          | ABC original              | False              |
| fixed      | covid_2020     | ABC-FAEM frozen mt=300           |    0.0017 | True          | ABC original              | True               |
| fixed      | covid_2020     | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| fixed      | covid_2020     | Adaptive FF f=0.15               |    0.0696 | False         | ABC original              | False              |
| fixed      | covid_2020     | Adaptive FF f=0.25               |    0.0362 | True          | ABC original              | False              |
| fixed      | covid_2020     | Adaptive FF f=0.25 (v1 roulette) |    0.0215 | True          | ABC original              | False              |
| fixed      | gfc_2007_2009  | ABC-FAEM active mt=9             |    0.0897 | False         | ABC original              | False              |
| fixed      | gfc_2007_2009  | ABC-FAEM frozen mt=300           |    0.0192 | True          | ABC original              | False              |
| fixed      | gfc_2007_2009  | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| fixed      | gfc_2007_2009  | Adaptive FF f=0.15               |    0.0826 | False         | ABC original              | False              |
| fixed      | gfc_2007_2009  | Adaptive FF f=0.25               |    0.3884 | False         | ABC original              | False              |
| fixed      | gfc_2007_2009  | Adaptive FF f=0.25 (v1 roulette) |    0.1140 | False         | ABC original              | False              |
| fixed      | war_2022       | ABC-FAEM active mt=9             |    0.0001 | True          | ABC original              | True               |
| fixed      | war_2022       | ABC-FAEM frozen mt=300           |    0.0002 | True          | ABC original              | True               |
| fixed      | war_2022       | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| fixed      | war_2022       | Adaptive FF f=0.15               |    0.0000 | True          | ABC original              | True               |
| fixed      | war_2022       | Adaptive FF f=0.25               |    0.0073 | True          | ABC original              | True               |
| fixed      | war_2022       | Adaptive FF f=0.25 (v1 roulette) |    0.0000 | True          | ABC original              | True               |
| fixed      | 2023_stability | ABC-FAEM active mt=9             |    0.0094 | True          | ABC original              | True               |
| fixed      | 2023_stability | ABC-FAEM frozen mt=300           |    0.0004 | True          | ABC original              | True               |
| fixed      | 2023_stability | Adaptive Dirichlet f=0.15        |    0.0010 | True          | Adaptive Dirichlet f=0.15 | True               |
| fixed      | 2023_stability | Adaptive FF f=0.15               |    0.0897 | False         | ABC original              | False              |
| fixed      | 2023_stability | Adaptive FF f=0.25               |    0.4091 | False         | ABC original              | False              |
| fixed      | 2023_stability | Adaptive FF f=0.25 (v1 roulette) |    0.0532 | False         | ABC original              | False              |
| dynamic    | covid_2020     | ABC-FAEM active mt=9             |    0.2774 | False         | ABC original              | False              |
| dynamic    | covid_2020     | ABC-FAEM frozen mt=300           |    0.5459 | False         | ABC original              | False              |
| dynamic    | covid_2020     | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| dynamic    | covid_2020     | Adaptive FF f=0.15               |    0.0441 | True          | ABC original              | False              |
| dynamic    | covid_2020     | Adaptive FF f=0.25               |    0.8408 | False         | ABC original              | False              |
| dynamic    | covid_2020     | Adaptive FF f=0.25 (v1 roulette) |    0.7841 | False         | ABC original              | False              |
| dynamic    | gfc_2007_2009  | ABC-FAEM active mt=9             |    0.7285 | False         | ABC original              | False              |
| dynamic    | gfc_2007_2009  | ABC-FAEM frozen mt=300           |    0.2943 | False         | ABC original              | False              |
| dynamic    | gfc_2007_2009  | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| dynamic    | gfc_2007_2009  | Adaptive FF f=0.15               |    0.0637 | False         | ABC original              | False              |
| dynamic    | gfc_2007_2009  | Adaptive FF f=0.25               |    0.4980 | False         | ABC original              | False              |
| dynamic    | gfc_2007_2009  | Adaptive FF f=0.25 (v1 roulette) |    0.3488 | False         | ABC original              | False              |
| dynamic    | war_2022       | ABC-FAEM active mt=9             |    0.0017 | True          | ABC original              | True               |
| dynamic    | war_2022       | ABC-FAEM frozen mt=300           |    0.0000 | True          | ABC original              | True               |
| dynamic    | war_2022       | Adaptive Dirichlet f=0.15        |    0.0000 | True          | Adaptive Dirichlet f=0.15 | True               |
| dynamic    | war_2022       | Adaptive FF f=0.15               |    0.0532 | False         | ABC original              | False              |
| dynamic    | war_2022       | Adaptive FF f=0.25               |    0.0073 | True          | ABC original              | True               |
| dynamic    | war_2022       | Adaptive FF f=0.25 (v1 roulette) |    0.0002 | True          | ABC original              | True               |
| dynamic    | 2023_stability | ABC-FAEM active mt=9             |    0.0107 | True          | ABC original              | True               |
| dynamic    | 2023_stability | ABC-FAEM frozen mt=300           |    0.0002 | True          | ABC original              | True               |
| dynamic    | 2023_stability | Adaptive Dirichlet f=0.15        |    0.0037 | True          | Adaptive Dirichlet f=0.15 | True               |
| dynamic    | 2023_stability | Adaptive FF f=0.15               |    0.0172 | True          | ABC original              | False              |
| dynamic    | 2023_stability | Adaptive FF f=0.25               |    0.2774 | False         | ABC original              | False              |
| dynamic    | 2023_stability | Adaptive FF f=0.25 (v1 roulette) |    0.0192 | True          | ABC original              | False              |

## 4. Formal hypothesis test — Holm correction and deflated Sharpe

The family of simultaneous comparisons inside each universe-period cell is the six non-baseline configurations of §3 (NaN p-values count as 1.0). Holm-corrected significant cells per configuration, split by direction:

| model                            |   holm_in_favor |   holm_against |
|:---------------------------------|----------------:|---------------:|
| ABC-FAEM active mt=9             |               0 |              4 |
| ABC-FAEM frozen mt=300           |               0 |              5 |
| Adaptive Dirichlet f=0.15        |               8 |              0 |
| Adaptive FF f=0.15               |               0 |              1 |
| Adaptive FF f=0.25               |               0 |              2 |
| Adaptive FF f=0.25 (v1 roulette) |               0 |              2 |

Per-cell detail for the winning configuration (`Adaptive Dirichlet f=0.15`): the Holm-corrected Wilcoxon outcome plus the deflated Sharpe ratio of its best-of-seeds portfolio — the daily-return Sharpe deflated against the trial set of all seven configurations' best portfolios in that cell (Bailey & López de Prado, 2014), with skewness and excess kurtosis from the winner's daily returns and `n_obs` equal to the window length:

| universe   | period         |   p_value | holm_significant   | in_favor   |   daily_sharpe |   deflated_sharpe |   n_obs |
|:-----------|:---------------|----------:|:-------------------|:-----------|---------------:|------------------:|--------:|
| fixed      | covid_2020     |    0.0000 | True               | True       |         0.1944 |            0.9832 |     124 |
| fixed      | gfc_2007_2009  |    0.0000 | True               | True       |         0.0246 |            0.6467 |     376 |
| fixed      | war_2022       |    0.0000 | True               | True       |         0.0609 |            0.6804 |     124 |
| fixed      | 2023_stability |    0.0010 | True               | True       |         0.1597 |            0.9998 |     501 |
| dynamic    | covid_2020     |    0.0000 | True               | True       |         0.1962 |            0.9801 |     124 |
| dynamic    | gfc_2007_2009  |    0.0000 | True               | True       |         0.0090 |            0.5095 |     376 |
| dynamic    | war_2022       |    0.0000 | True               | True       |         0.0699 |            0.7208 |     124 |
| dynamic    | 2023_stability |    0.0037 | True               | True       |         0.1486 |            0.9997 |     501 |

Hypothesis — replacing the dormant scout with `Adaptive Dirichlet f=0.15` improves on ABC original. Result — after Holm correction within each cell (six simultaneous comparisons), the improvement stays significant and in the winner's favor in 8 of 8 cells; the per-cell deflated Sharpe is at least 0.95 in 4 of 8 cells (minimum 0.510). The hypothesis therefore survives only partially — see the per-cell table. Scope caveats: windows are evaluated in-sample under the thesis conventions, and the deflation covers the seven configurations tested here rather than the full design space — the SG-5 walk-forward study remains the confirmatory step.

## 5. Interpretation

The strongest adaptive configuration is `Adaptive Dirichlet f=0.15` with mean per-seed Sortino 2.870 across the 8 universe-period cells: +0.726 versus ABC original and +0.906 versus the prior diagnostic's best (`ABC-FAEM active mt=9`). Of its 8 paired Wilcoxon tests against ABC original, 8 are significant at 5% (8 in its favor). §4 applies the formal Holm/deflated-Sharpe control to this grid; the SG-5 walk-forward study owns the confirmatory claim under calibrated policies.
...
- **Wilcoxon signed-rank (paired seeds)** — the thesis's own significance methodology (comment 10). Holm–Bonferroni and the deflated Sharpe ratio (`hive_abc.metrics`, SG-3) are applied in §4; the SG-5 walk-forward study remains the confirmatory gate.
...
3. Cite the v2 line as future work exactly as `pfa_sensitivity.md` §5 already frames it: a joint `max_trials`-and-move calibration with honest multiple-testing control, now implemented in the repository (`ABCAdaptiveScout`, telemetry, and the `hive_abc.calibration` framework).
